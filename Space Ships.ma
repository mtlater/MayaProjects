...
//Name: Space Ships.ma
//Last modified: Tue, May 20, 2014 12:10:43 PM
//Codeset: 1252
requires maya "2014";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -2.0649516886309804 24.062567531367094 -8.9876505719370279 ;
	setAttr ".r" -type "double3" -68.738352719317703 -1251.7999999995213 0 ;
	setAttr ".rpt" -type "double3" -1.630056614782142e-015 -2.4144375503763264e-015 
		1.8275953033533278e-015 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 24.478656577653783;
...
connectAttr "deleteComponent51.og" "pCubeShape2.i";
